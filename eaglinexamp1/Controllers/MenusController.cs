...
namespace eaglinexamp1.Controllers
{
    public class MenusController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MenuID,MenuTitle,MenuDescritpion")] Menu menu)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MenuID,MenuTitle,MenuDescritpion")] Menu menu)
        {
            if (ModelState.IsValid)
            {
